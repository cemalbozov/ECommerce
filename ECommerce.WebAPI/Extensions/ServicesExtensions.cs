...
namespace ECommerce.WebAPI.Extensions
{
    public static class ServicesExtensions
    {
        ...
        public static void AddCustomMediaTypes(this IServiceCollection services)
        {
            services.Configure<MvcOptions>(config =>
            {
                ...
                if (systemTextJsonOutputFormatter != null)
                {
                    ...
                    .Add("application/vnd.ecommerce.hateoas+json");

                    systemTextJsonOutputFormatter.SupportedMediaTypes
                    .Add("application/vnd.ecommerce.apiroot+json");
                }
                ...
                if (xmlOutputFormatter != null)
                {
                    ...
                    .Add("application/vnd.ecommerce.hateoas+xml");

                    xmlOutputFormatter.SupportedMediaTypes
                    .Add("application/vnd.ecommerce.apiroot+xml");
                }
            });
        }
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            ...
            {
                s.SwaggerDoc("v1", new OpenApiInfo { Title = "ECommerce", Version = "v1" });
                s.SwaggerDoc("v2", new OpenApiInfo { Title = "ECommerce", Version = "v2" });
